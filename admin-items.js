...
const filterTitles = { all: "รายการสิ่งของทั้งหมด", waiting: "รอยืนยันการรับฝาก", claimed: "รอส่งคืนเจ้าของ", returned: "ส่งคืนแล้ว" };
    ...
    filteredItems.forEach((item) => {
        ...
        card.innerHTML = `
            ...
            <div class="item-info">
                ...
                <div class="item-detail">${item.found_date || "-"} ${item.found_time || ""}</div>
            </div>
            <div class="item-status">
